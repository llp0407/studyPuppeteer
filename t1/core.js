...
(async () => {
    ...
    // for(let i1=0;i1<1;i1++){
        ...
        // const std_cat = await page.$$eval(".listing-category>.each-category>h4", e => {
        //     const data = []
        //     for(let i=0;i<e.length;i++){
        //         data.push(e[i].innerText)
        //     }
        //     return data
        // })
        // console.log('std_cat',std_cat)   //当前页面所有的std_cat
                                ...
                                for(let i_4=0;i_4<level3_li.length;i_4++){
                                    if(level3_li[i_4].querySelectorAll('.listing-level4.listing-alignment').length==0){
                                        ...
                                        for(let i_5=0;i_5<level4_li.length;i_5++){
                                            ...
                                            // let level4_li = level3_li[i_4].querySelectorAll('.listing-level4>.each-alignment')
                                            if(level4_li[i_5].querySelectorAll('.listing-level5.isting-alignment').length == 0){
                                                // 第五级没有说明没有了
                                                let ref_code = ''
                                                let ref_text = ''
                                                let result = {
                                                ...
                                                let level5_li = level4_li[i_5].querySelectorAll('.listing-level5>.each-alignment')
                                        ...
                                        let std_sub_code = ''
                                        let std_sub_text = ''
                                        let level4_li = level3_li[i_3].querySelectorAll('.listing-level4>.each-alignment')
                                        for(let i_5=0;i_5<level4_li.length;i_5++){
                                            let level4_a_text = level4_li[i_5].querySelector('a').innerText
                                            let star3 = level4_a_text.indexOf('(')
                                            let ref_code = level4_a_text.substr(star3)
