...
(async () => {
    ...
    const selectedSongHref = await iframe.evaluate(e => {
        ...
        const idx = songList.findIndex(v => v.childNodes[1].innerText.replace(/\s/g, '') === '玫瑰花的葬礼');
    ...
    // 写入文件
    let writerStream = fs.createWriteStream('玫瑰花的葬礼.txt');
    ...
    let pl = fs.createWriteStream('评论.txt');
    pl.write(commentList.toString(), 'UTF8');
    pl.end();
